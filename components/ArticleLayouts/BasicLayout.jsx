      ...
      <section className="main-article">
        ...
        <header className="header-basic">
          <div className="header-basic-content">
            <h5 className="article-meta">
              <span
                className={`bg-dark-500 p-1 text-light-500-500 dark:bg-light-500 dark:text-dark-500`}
              >
        ...
        {frontmatter.gallery && frontmatter.gallery.length > 0 && (
          <div className="article-grid">
            <h3 className="mb-4 bg-dark-500 text-3xl font-bold text-light-500-500 dark:bg-light-500 dark:text-dark-500">
        ...
        {tags && tags.length > 0 && (
          <div className="article-grid">
            <h4 className="text-2xl font-bold bg-dark-500 text-light-500-500 dark:!bg-light-500 dark:!text-dark-500 my-4">
              ...
              {prev.frontmatter && (
                <div className="mb-6">
                  <h4 className="mb-4 text-2xl font-bold tracking-wide">
                    <span className="marker-line bg-dark-500 !p-2 text-light-500-500 dark:bg-light-500 dark:text-dark-500">
                      Artigo anterior
                    </span>
                  </h4>
                  <CardBasic
