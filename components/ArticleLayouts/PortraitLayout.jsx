      ...
      <section className="main-article">
            ...
            <div className="h-full flex flex-col justify-center">
              <div className="header-portrait-content">
                <h5 className="md:text-2xl text-xl font-medium tracking-wide text-center mb-4">
                  <span className="background-texture p-1 dark:bg-dark-500 dark:text-light-500-500 bg-light-500 text-dark-500">
        ...
        {frontmatter.gallery && frontmatter.gallery.length > 0 && (
          <div className="article-grid">
            <h3 className="text-3xl font-bold bg-dark-500 text-light-500-500 dark:bg-light-500 dark:text-dark-500 mb-4">
              ...
              {prev.frontmatter && (
                <div className="mb-6">
                  <h4 className="text-2xl font-bold tracking-wide mb-4">
                    <span className="marker-line !p-2 bg-dark-500 text-light-500-500 dark:bg-light-500 dark:text-dark-500">
                      Artigo anterior
                    </span>
                  </h4>
                  <CardBackground
